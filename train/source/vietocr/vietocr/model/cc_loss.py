...
class CCLoss(nn.Module):
    ...
    def __init__(self,
        ...
        self.loss = SupConLoss(temperature=temperature, contrast_mode=contrast_mode, base_temperature=base_temperature)
        self.flatten = True
...
class SupConLoss(nn.Module):
    ...
    def __init__(self, temperature=0.7, contrast_mode='one',
